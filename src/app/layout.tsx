...
export const metadata: Metadata = {
  title: "MasturCoders - Ukrainian IT Solutions & Development",
  description: "MasturCoders delivers cutting-edge software development, web applications, and digital transformation services for global enterprises.",
  keywords: "IT company, software development, Ukrainian tech, web development, mobile apps, cloud solutions, software engineering",
  metadataBase: new URL("https://masturocoders.com"),
  alternates: {
    canonical: "https://masturocoders.com"
  },
  openGraph: {
    title: "MasturCoders - Ukrainian IT Company",
    description: "Transform your business with innovative software solutions from MasturCoders.",
    type: "website",
    siteName: "MasturCoders",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764869949036-j8n6i6dv.jpg",
        alt: "MasturCoders"
      }
    ]
  },
  twitter: {
    ...
    title: "MasturCoders - IT Solutions",
    description: "Ukrainian software development company delivering enterprise solutions worldwide.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764869949036-j8n6i6dv.jpg"]
  },
  robots: {
    index: true,
    follow: true
